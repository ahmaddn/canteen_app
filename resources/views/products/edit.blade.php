                        ...
                        <div class="basic-form">
                            ...
                            <form action="{{ route('products.update', $product->id) }}" method="POST"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" placeholder="AAAA - 0000" name="sku"
                                            id="sku-num" value="{{ old('sku', $product->sku) }}">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" rows="5" placeholder="Description" name="desc">{{ old('desc', $product->description) }}</textarea>
                                        @error('desc')
                                        ...
                                        <div class="input-group">
                                            <div class="form-file">
                                                <input type="file" class="form-file-input form-control"
                                                    name="attachments" value="{{ old('attachments', $product->sku) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
